...
export const metadata = buildMetadata({
  ...
  title: "Resource Library | Farcelis AI Consulting",
  description:
    "Request access to Farcelis briefings, field guides, reports, playbooks, and diagnostic resources for operational systems, AI readiness, CRM, and growth work.",
});
  ...
  return (
    <>
      <PageIntro
        ...
        title="Briefings, guides, and reports for leaders deciding what to build next."
        description="Farcelis resources help buyers evaluate AI readiness, workflow architecture, Control Layer design, CRM operations, and growth systems before committing to a build."
        actions={[
          { href: "#request-access", label: "Request Access" },
          { href: "/resources", label: "Explore Resources", variant: "secondary" },
        ]}
