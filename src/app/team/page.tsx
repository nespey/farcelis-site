            ...
            <div className="mx-auto grid max-w-[1180px] gap-5 md:grid-cols-2">
              {teamMembers.map((member, index) => (
                <Link
                  ...
                  className="group grid overflow-hidden rounded-[24px] border border-slate-200 bg-white shadow-[0_18px_40px_rgba(15,23,42,0.07)] transition hover:-translate-y-1 hover:shadow-[0_24px_48px_rgba(15,23,42,0.12)] sm:grid-cols-[220px_minmax(0,1fr)]"
                >
                  <div className="relative aspect-[4/5] overflow-hidden sm:h-full sm:min-h-[280px]">
                    <Image
                      src={member.image}
                      alt={member.name}
                      fill
