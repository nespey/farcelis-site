  ...
  return (
    <section className="hero-surface relative min-h-[100svh] overflow-hidden bg-[linear-gradient(180deg,#020617_0%,#07111f_46%,#0b1523_100%)] px-4 pb-10 pt-20 sm:px-6 lg:px-12 lg:pb-12 lg:pt-24">
      ...
      <div className="relative mx-auto grid min-h-[calc(100svh-8rem)] max-w-[1200px] items-center gap-10 lg:grid-cols-[minmax(0,0.8fr)_minmax(560px,1fr)] lg:gap-8">
        <div className="hero-copy max-w-[600px] lg:justify-self-center lg:pr-2">
        ...
        <div className="hero-panel relative lg:justify-self-end">
          ...
          <div className="grid gap-4 border border-white/10 bg-[linear-gradient(180deg,rgba(2,6,23,0.78),rgba(15,23,42,0.68))] p-4 shadow-[0_48px_140px_rgba(2,6,23,0.5),inset_0_1px_0_rgba(255,255,255,0.06),inset_0_-16px_40px_rgba(2,6,23,0.28)] backdrop-blur-md sm:p-5 lg:w-[720px] lg:p-6">
            <div className="grid gap-px overflow-hidden border border-white/10 bg-white/10 lg:grid-cols-[0.8fr_1.2fr]">
              <div className="bg-slate-950/82 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
              ...
              <div className="bg-white p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.45)]">
            ...
            <div className="grid gap-px overflow-hidden border border-white/10 bg-white/10 md:grid-cols-3">
              <div className="bg-[#09111d] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
              ...
              <div className="bg-[#0d1a2c] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
                <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-white/36">
                  Decisions
                </p>
                <p className="mt-5 text-lg font-semibold tracking-[-0.04em] text-white">
              ...
              <div className="bg-[linear-gradient(135deg,#9f412c,#144a6a)] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.12)]">
