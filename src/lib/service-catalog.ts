...
export const directServices: DirectService[] = [
  ...
  },
  {
    ...
    title: "Launch and hosting support for websites, apps, and tools.",
    summary:
      "Farcelis helps businesses launch, host, update, and maintain the websites, apps, portals, dashboards, and tools we build or clean up.",
    primaryCta: "Discuss deployment operations",
    secondaryCta: { href: "/services/workflow-managed-operations", label: "See managed operations" },
    capabilities: [
      "Launch planning and setup",
      "Website and app hosting support",
      "Domain and environment review",
      "Release and update checks",
      "Access and handoff documentation",
      "Maintenance and support rhythm",
    ],
    process: [
    ...
    related: [
      {
        href: "/services/workflow-managed-operations",
        label: "Workflow & Managed Operations",
        detail: "Keep the system moving after launch.",
      },
      {
        href: "/services/app-portal-development",
        label: "App & Portal Development",
        detail: "Build the tool with launch in mind.",
      },
      {
        href: "/control-layer",
        label: "Farcelis Control Layer",
        detail: "Keep live work visible.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    title: "SEO that helps people find your business when they search.",
    summary:
    ...
    capabilities: [
      ...
      "Internal links and search paths",
      "Local and business search signals",
      "Search-ready content cleanup",
    ],
    process: [
    ...
    related: [
      {
        href: "/services/website-development",
        label: "Website Development",
        detail: "Give search traffic a clear page path.",
      },
      {
        href: "/services/aeo-ai-search-visibility",
        label: "AEO / AI Search Visibility",
        detail: "Make pages easier for AI tools to cite.",
      },
      {
        href: "/services/content-revenue-systems",
        label: "Content & Revenue Systems",
        detail: "Keep search content publishing.",
      },
    ],
  },
  {
    ...
    title: "AI search visibility that helps answer engines understand your business.",
    summary:
    ...
    capabilities: [
      ...
      "Schema and proof signals",
      "Resource paths for citations",
    ...
    related: [
      {
        href: "/services/seo-search-visibility",
        label: "SEO & Search Visibility",
        detail: "Strengthen the search foundation.",
      },
      {
        href: "/resources",
        label: "Resources",
        detail: "Use proof assets for answers.",
      },
      {
        href: "/services/content-revenue-systems",
        label: "Content & Revenue Systems",
        detail: "Keep answer-ready content moving.",
      },
    ],
  },
  {
    ...
    related: [
      {
        href: "/services/website-development",
        label: "Website Development",
        detail: "Build landing pages for ad traffic.",
      },
      {
        href: "/services/crm-revenue-operations",
        label: "CRM & Revenue Operations",
        detail: "Route paid-search leads.",
      },
      {
        href: "/services/meta-ads-paid-social",
        label: "Meta Ads / Paid Social",
        detail: "Build demand alongside search.",
      },
    ],
  },
  {
    ...
    title: "Meta ads that put your offer in front of the right audience.",
    summary:
    ...
    capabilities: [
      ...
      "Lead forms and follow-up paths",
      "Paid social reporting",
      "Campaign cleanup and improvement",
    ],
    process: [
    ...
    related: [
      {
        ...
        label: "Google Ads / Paid Search",
        detail: "Capture search demand too.",
      },
      {
        href: "/services/content-revenue-systems",
        label: "Content & Revenue Systems",
        detail: "Use campaign learning in content.",
      },
      {
        href: "/services/crm-revenue-operations",
        label: "CRM & Revenue Operations",
        detail: "Route paid-social leads.",
      },
    ],
  },
  {
    ...
    related: [
      ...
      },
      {
        href: "/services/crm-revenue-operations",
        label: "CRM & Revenue Operations",
        detail: "Route leads into clean follow-up.",
      },
      {
        href: "/services/seo-search-visibility",
        label: "SEO & Search Visibility",
        detail: "Use paid learning to sharpen search.",
      },
    ],
  },
  {
    ...
    related: [
      ...
      },
      {
        href: "/services/workflow-managed-operations",
        label: "Workflow & Managed Operations",
        detail: "Clarify ownership and handoffs.",
      },
      {
        href: "/services/google-ads-paid-search",
        label: "Google Ads / Paid Search",
        detail: "Make campaign leads visible.",
      },
    ],
  },
  {
    ...
    title: "CRM systems that keep leads, follow-up, and revenue moving.",
    summary:
    ...
    related: [
      {
        href: "/services/quote-pricing-tools",
        label: "Quote & Pricing Tools",
        detail: "Send quotes into follow-up.",
      },
      {
        href: "/services/platform-connections",
        label: "Platform Connections",
        detail: "Connect forms, email, and CRM.",
      },
      {
        href: "/services/content-revenue-systems",
        label: "Content & Revenue Systems",
        detail: "Tie campaigns to lead handling.",
      },
    ],
  },
  {
    ...
    title: "Content systems that keep pages, offers, and campaigns moving.",
    summary:
    ...
    related: [
      {
        href: "/services/seo-search-visibility",
        label: "SEO & Search Visibility",
        detail: "Make content findable.",
      },
      {
        href: "/services/google-ads-paid-search",
        label: "Google Ads / Paid Search",
        detail: "Use ad tests to improve offers.",
      },
      {
        href: "/insights",
        label: "Insights",
        detail: "Use thinking as public proof.",
      },
    ],
  },
  {
    ...
    title: "Reporting systems that show what needs action.",
    summary:
    ...
    capabilities: [
      ...
      "Decision-ready status views",
      "Leadership review rhythm",
      "Owner and next-step visibility",
      "Revenue and operations signals",
      "Report cleanup and automation",
    ],
    process: [
    ...
    related: [
      {
        href: "/control-layer",
        label: "Farcelis Control Layer",
        detail: "Place reporting inside one view.",
      },
      {
        href: "/services/workflow-managed-operations",
        label: "Workflow & Managed Operations",
        detail: "Connect reports to workflow.",
      },
      {
        href: "/services/deployment-operations",
        label: "Deployment Operations",
        detail: "Use reports to drive follow-through.",
      },
    ],
  },
  {
    slug: "ai-strategy-governance",
    navLabel: "AI Strategy & Governance",
    eyebrow: "Operate / AI Strategy & Governance",
    title: "AI strategy that helps teams use AI without losing control.",
    summary:
      "Farcelis helps businesses decide where AI should help, what rules it needs, who reviews it, and how to use AI safely inside real work.",
    primaryCta: "Discuss AI strategy and governance",
    secondaryCta: { href: "/services/ai-agents-automations", label: "See AI agents" },
    capabilities: [
      "AI use-case review",
    ...
    process: [
      "Identify where AI can actually help the business.",
      "Decide what data, tools, and use cases are allowed.",
      "Define who reviews AI-assisted work before it moves.",
      "Document practical rules the team can follow.",
      "Connect AI strategy to workflows, reporting, and support.",
    ],
    signals: [
      "People are using AI, but the rules are unclear.",
      "The business wants AI help without risking privacy or quality.",
      "Teams need practical guardrails before automations are built.",
    ],
    exclusions: [
      "AI strategy with no operating owner.",
      "Rules that sound impressive but no one can follow.",
      "Automation before the risk, data, and review path is clear.",
    ],
    related: [
      {
        href: "/services/ai-agents-automations",
        label: "AI Agents & Automations",
        detail: "Build only after rules are clear.",
      },
      {
        href: "/services/workflow-managed-operations",
        label: "Workflow & Managed Operations",
        detail: "Keep AI work owned and reviewed.",
      },
      {
        href: "/services/reporting-decision-systems",
        label: "Reporting & Decision Systems",
        detail: "Show AI activity and risk clearly.",
      },
    ],
  },
  {
    ...
    title: "Managed operations that keep daily work moving after launch.",
    summary:
    ...
    secondaryCta: { href: "/services/deployment-operations", label: "See launch support" },
    capabilities: [
      "Task and owner mapping",
      "Handoff and follow-up rhythm",
    ...
    related: [
      {
        href: "/services/deployment-operations",
        label: "Deployment Operations",
        detail: "Keep live systems stable.",
      },
      {
        href: "/control-layer",
        label: "The Farcelis Control Layer",
        detail: "Use one shared view for work.",
      },
      {
        href: "/services/reporting-decision-systems",
        label: "Reporting & Decision Systems",
        detail: "Make work visible to leaders.",
      },
    ],
  },
];
